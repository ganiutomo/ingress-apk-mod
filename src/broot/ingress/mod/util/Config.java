...
public class Config {
	...
	public static void load() {
		final SharedPreferences prefs = Mod.app.getSharedPreferences("mod", 0);
	...
	public static void nextUiVariant() {
		final List<UiVariant> variants = UiVariant.variants;
		uiVariant = variants.get((variants.indexOf(uiVariant) + 1) % variants.size());
		save();
	}

	public static void save() {
		final SharedPreferences.Editor e = Mod.app.getSharedPreferences("mod", 0).edit();
